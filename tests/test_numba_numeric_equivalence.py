...
import hawkes_tools.hawkes.numeric as numeric
...
class NumbaNumericEquivalenceTest(unittest.TestCase):
    ...
    def test_numba_is_mandatory_in_subprocess(self):
        env = os.environ.copy()
        ...
        command = [
            ...
            "assert numeric.NUMBA_AVAILABLE; "
            "assert numeric.is_numba_enabled()",
        ]
