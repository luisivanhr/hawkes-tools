...
RESOLVED_IN_THIS_SLICE = {
    "reference/hawkes/simulation/tests/simu_hawkes_test.py": [
        "Test.test_simu_hawkes_force_simulation",
    ],
    "reference/hawkes/simulation/tests/simu_inhomogeneous_poisson_test.py": [
        "Test.test_simulation_1d_inhomogeneous_poisson",
    ],
    "reference/hawkes/simulation/tests/simu_point_process_test.py": [
        "Test.test_simulation_time",
    ],
    "reference/hawkes/simulation/tests/simu_poisson_test.py": [
        "Test.test_simulation_1d_poisson",
        "Test.test_simulation_nd_poisson",
    ],
    "reference/hawkes/inference/tests/hawkes_basis_kernels_test.py": [
        "Test.test_em_basis_kernels",
    ],
    "reference/hawkes/inference/tests/hawkes_sumgaussians_test.py": [
    ...
    "reference/hawkes/inference/tests/hawkes_adm4_test.py": [
        "Test.test_sparse",
    ...
    "reference/hawkes/inference/tests/hawkes_conditional_law_test.py": [
    ...
    "reference/hawkes/inference/tests/hawkes_cumulant_matching_test.py": [
        "Test.test_hawkes_cumulants",
        "Test.test_hawkes_cumulants_unfit",
    ],
    "reference/hawkes/inference/tests/hawkes_em_test.py": [
    ...
    "reference/hawkes/inference/tests/hawkes_expkern_test.py": [
    ...
    "reference/hawkes/inference/tests/hawkes_sumexpkern_test.py": [
        "Test.test_sparse",
